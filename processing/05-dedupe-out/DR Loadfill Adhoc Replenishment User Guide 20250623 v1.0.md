```json
{
  ...
  "dedupe_report": {
    ...
    "merged_similar": [],
    "notes": [
      "No exact or near-duplicate entries found within fields.",
      "Keywords lowercased and trimmed; plurals preserved as per original.",
      "Pseudonyms kept distinct and meaningful.",
      "Steps preserved in original order with no redundant or boilerplate repeats."
    ]
  }
}
```